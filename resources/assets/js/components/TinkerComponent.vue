    ...
    <div >
        ...
        <ul class="ChatLog">
            ...
            <img class="ChatLog__message__image" :src="message.attachment.url" v-if="message.attachment.type === 'image'" />
                ...
                <iframe  v-if="message.attachment.type === 'file'" :src="message.attachment.url" style="overflow:hidden; padding:0px;"
...
<!-- @keyup.enter="sendMessage"-->
      ...
      <!--  <input type="image" src="\twotone_send_black_18dp.png" class="Chatattachment" :submit="sendMessage" v-model="newMessage">-->
...
//if i want to add database of messages change would be in these lines
